...
export function Iphone({
  ...
  const screenBgColor =
    variant === "light"
      ...
      : variant === "dark"
        ...
        : "fill-[#E5E5E5] stroke-[#E5E5E5] dark:fill-[#404040] dark:stroke-[#404040]";
  ...
  const notchBgColor =
    variant === "light"
      ...
      : variant === "dark"
        ? "fill-[#262626]"
        : "fill-[#ffffff] dark:fill-[#262626]";

  const notchDetailColor =
    variant === "light"
      ? "fill-[#ffffff]"
      : variant === "dark"
        ? "fill-[#404040]"
  ...
  return (
    ...
    >
      ...
      {!hasVideo && src && (
        <div
          className="pointer-events-none absolute bg-white z-0 overflow-hidden"
          style={{
            left: `${LEFT_PCT}%`,
            top: `${TOP_PCT}%`,
            width: `${WIDTH_PCT}%`,
        ...
        >
          <img
            src={src}
            alt=""
            className="block w-full h-full object-contain object-top pt-4 bg-white"
          />
        </div>
      )}
